              ...
              return (
                <tr key={r.id} onClick={()=>onSelect(r)}
                  ...
                  <td className="px-4 py-3.5">
                    ...
                    {r.tenant_name&&(
                      <span className="mt-1 inline-flex max-w-[170px] items-center gap-1 truncate rounded-md bg-muted px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground">
                        <span className="size-1.5 shrink-0 rounded-full bg-primary/40"/>
                        <span className="truncate">{r.tenant_name}</span>
                      </span>
                    )}
                  </td>
